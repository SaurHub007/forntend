...
const Kitchen = () => {
  return (
    <div 
      ...
      style={{ backgroundImage: "url('https://stylebyemilyhenderson.com/wp-content/uploads/2024/05/Emily-Henderson_A-1000-x-Better_Bright-Wooden-Kitchen_Modern-Midcentury-Modern_OPENER.jpg')" }}
    >
      ...
      <h1 className="text-5xl md:text-6xl font-extrabold text-white text-center mt-12 z-10">
        Welcome to the Kitchen Section
      </h1>
      ...
      <div className="flex-grow flex flex-col items-center justify-center text-center z-10">
        ...
        <img 
          ...
          alt="Smiling Worker" 
          className="w-80 h-70 mb-4 object-cover shadow-lg"
        />
